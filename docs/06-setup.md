...
_Setup gerado automaticamente. Qualquer desvio identificado durante a implementação deve ser registrado na seção "Desvios" deste documento e em `docs/progress.md`._
